...
namespace Vista.Principal
{
    public partial class FrmActionProduct : Form
    {
        ...
        public FrmActionProduct(int id, long barcode, string brand, string description, decimal price, int stock) : this()
        {
            productId = id;
        ...
        private void FrmActionProduct_Load(object sender, EventArgs e)
        {
            LoadComboCategory();
        }
